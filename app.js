                    ...
                    var request = sg.emptyRequest({
                        ...
                        body: {
                            ...
                            content: [{
                                type: 'text/html',
                                value: '<html><body>' +
                                    '<b> Thanks for registering At TweaksUp.... <br><br></b>' +

                                    ' So what are you waiting for , <br>' +

                                    "<a href='https://tweaksup.herokuapp.com/confirmation/username/" + details.username + "' target='_blank'> 'Click on the link to activate your account'</a><br>" +
